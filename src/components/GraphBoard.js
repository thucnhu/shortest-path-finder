...
export default function GraphBoard() {
	...
	const test = () => {
		...
		graph.addEdges(
			{ id: 'e5-2', source: '5', target: '2', label: '45' }
		)
	}

	
	return (
		<div className=' h-full min-w-[30rem] w-full flex flex-col items-end'>
				<div id='graph' className='w-full h-full border-2 border-black rounded-md' 
				...
				<button className='btn-green mt-5' onClick={test}>Test</button>
		</div>
	)
}
